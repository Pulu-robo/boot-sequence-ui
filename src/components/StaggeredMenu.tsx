          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
                  ...
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    ...
                    >
                      <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform">
                        {it.label === 'Architecture' ? (
                          <>
                            Architecture<sup className="text-[1.5rem] font-normal ml-2" style={{ color: 'var(--sm-accent, #ffa629)' }}>01</sup>
                          </>
                        ) : (
                          it.label
                        )}
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#ff0000)]">Contact</h3>
                <ul
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(320px, 45vw, 520px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 3em 2em 3em; overflow-y: auto; z-index: 10; }
